    ...
    <div class="flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="relative inline-block text-left">
                ...
                {#if open}
                    <div on:click|stopPropagation={()=>{}} on:keydown={menuKeyboardListener} in:fade="{{delay: 250, duration: 300, easing: quintOut, axis: 'y'}}" out:fade="{{delay: 250, duration: 300, easing: quintOut, axis: 'y'}}" class="absolute right-0 z-10 mt-2 whitespace-nowrap origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 p-1 focus:outline-none space-y-2" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
